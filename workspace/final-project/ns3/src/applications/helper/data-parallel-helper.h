 ...
 */
#ifndef DATA_PARALLEL_HELPER_H
#define DATA_PARALLEL_HELPER_H
...
public:
   ...
   *        to.
   */
  DataParallelHelper (std::string protocol, Ptr<MLSchedule> schedule, Address remote);
